            ...
            <View style={styles.container}>
                ...
                {period !== 'p5' ?
                    (period === 0
                        ?
                        <>
                            <Text h2>No Class</Text>
                        </>
                        :
                        (periodData?.subject === null ?
                            <>
                                <Text h2>Free Period Enjoy!</Text>
                            </>
                            :
                            <>
                                <Text h2>Subject :{periodData?.subject}</Text>
                                <Text h2>Venue :{periodData?.venue}</Text>
                            </>
                        )
                    )
                    :
                    <>
                        <Text style={styles.recess} h2>{data.recessComment}</Text>
                    </>
                }
                {notices.length !== 0 ?
